...
SCENARIOS = [
    ...
    {"id": 54, "category": "session_budget",
     "transaction": {**_txn("t054", amount=100.00), "session_id": None},
     "rules": [{"id": "sb4", "type": "session_budget", "priority": 1,
                "params": {"max_session": 500}, "action": "BLOCK"}],
     "prior_transactions": [
         {**_txn("t054a", amount=450.00), "session_id": None},
     ],
     "expected": "BLOCKED",
     "description": "Missing session_id cannot bypass session budget evaluation"},

    # ─── Cascade Cost (inspired by HeartFlow / @yun520-1) ───
    {"id": 55, "category": "cascade_cost",
     "transaction": {**_txn("t055", amount=50.00), "fail_probability": 0.3, "reversal_cost": 200},
    ...
    {"id": 56, "category": "cascade_cost",
     "transaction": {**_txn("t056", amount=10.00), "fail_probability": 0.1, "reversal_cost": 50},
    ...
    {"id": 57, "category": "cascade_cost",
     "transaction": {**_txn("t057", amount=10.00), "estimated_cascade_cost": 150},
