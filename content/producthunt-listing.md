...
Stop runaway AI agents before they burn your budget. 7 composable rules evaluated per-transaction in <1ms. Pure Python stdlib, zero dependencies. Deploy in 60 seconds. 50/50 eval gym included. Open source + managed hosting ($19/mo).
...
Eval gym (50/50 across 7 categories): https://agentshield.fly.dev/eval
