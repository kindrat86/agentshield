  ...
  <text x="193" y="19" font-family="-apple-system,BlinkMacSystemFont,sans-serif" font-size="10" font-weight="700" fill="{color}">{label}</text>
    ...
    def _serve_blog(self):
        ...
        if os.path.exists(blog_path):
            ...
            description = "How I built AgentShield: a Python stdlib-only firewall for AI agent spending. Composable spend rules evaluated per-transaction in under 1ms. 74/74 eval gym."
