...
SCENARIOS = [
    ...
    {"id": 59, "category": "session_budget",
     "transaction": {**_txn("t059", amount=100.00), "session_id": None},
     "rules": [{"id": "sb4", "type": "session_budget", "priority": 1,
                "params": {"max_session": 500}, "action": "BLOCK"}],
     "prior_transactions": [
         {**_txn("t059a", amount=450.00), "session_id": None},
     ],
     "expected": "BLOCKED",
     "description": "Missing session_id cannot bypass session budget evaluation"},

    {"id": 60, "category": "transaction_limit_block",
     "transaction": _txn("t060", amount=-1000000.00),
    ...
    {"id": 61, "category": "transaction_limit_block",
     "transaction": _txn("t061", amount=0.00),
     "rules": [{"id": "r1", "type": "transaction_limit", "priority": 1,
                "params": {"max_amount": 500}, "action": "BLOCK"}],
     "prior_transactions": [],
     "expected": "BLOCKED",
    ...
    {"id": 62, "category": "cascade_cost",
     "transaction": {**_txn("t062", amount=50.00), "estimated_cascade_cost": -10},
